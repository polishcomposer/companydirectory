<?php
	...
	$queryFirstLastName = 'SELECT * FROM personnel WHERE firstName = "' . $_POST['firstName'] . '" AND lastName = "' . $_POST['lastName']  . '" AND id != "' . $_POST["id"] . '"';
...
if($_POST['jobTitle']) {
	...
	$query =   'UPDATE personnel SET firstName = "' . $_POST["firstName"] . '", lastName = "' . $_POST["lastName"] . '", jobTitle = ' . $POSTjobTitle . ', email = "' . $_POST["email"] . '", departmentID = "' . $_POST["departmentID"] . '" WHERE id = "'. $_POST["id"] .'"';
